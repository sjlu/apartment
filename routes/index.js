...
var paymentsFilePath = path.join(__dirname, "../data/payments.json");
var people = ["steve", "shy"];

router.get('/payments', function(req, res, next) {
  jsonfile.readFile(paymentsFilePath, function(err, payments) {
...
router.post('/payments', function(req, res, next) {
  ...
  jsonfile.readFile(paymentsFilePath, function(err, payments) {
    ...
    jsonfile.writeFile(paymentsFilePath, payments, function(err) {
      if (err) return next(err);
